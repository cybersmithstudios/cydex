...
import { MapPin, Clock, Leaf, Package, AlertCircle } from 'lucide-react';
...
export const OrderCard: React.FC<OrderCardProps> = ({ 
  ...
  const totalEarnings = Number(order.delivery_fee) + Number(order.eco_bonus);
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all duration-200 hover:border-primary/30">
      ...
      <Button
        ...
        disabled={loading}
        className="w-full bg-primary hover:bg-primary/90 text-black font-medium text-sm h-9"
