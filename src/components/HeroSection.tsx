  ...
  return <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-12 space-y-6 mb-10 lg:mb-0 text-center lg:text-left px-[10px]">
          ...
          <div className={`lg:w-1/2 w-full relative transition-all duration-1000 delay-300 transform ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}>
            <div className="relative px-6 lg:px-0">
              ...
              <div className="glass rounded-2xl overflow-hidden relative z-10 w-full h-[300px] sm:h-[360px] md:h-[400px]">
                {deliveryImages.map((image, index) => <div key={index} className={`transition-opacity duration-700 absolute inset-0 ${currentImageIndex === index ? 'opacity-100' : 'opacity-0'}`}>
