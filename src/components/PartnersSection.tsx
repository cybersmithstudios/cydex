      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {partnersData.map((partner, index) => (
            ...
            >
              <div className="p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-300 w-full h-32 flex items-center justify-center hover:shadow-md">
                <img
                  src={partner.logo}
                  alt={partner.name}
        ...
        <div className={`mt-16 text-center transform transition-all duration-700 delay-500 ${
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <div className="px-4 py-2 rounded-full bg-primary/10 text-sm font-medium">
              Carbon Neutral
            </div>
            <div className="px-4 py-2 rounded-full bg-primary/10 text-sm font-medium">
