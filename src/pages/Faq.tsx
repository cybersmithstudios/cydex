...
const Faq = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-28 md:pt-28 pb-10 md:pb-16 bg-gradient-to-b from-background to-muted/30">
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
          ...
          <div className="mb-12">
            ...
            <Accordion type="single" collapsible className="bg-card shadow-sm sm:shadow-md rounded-lg sm:rounded-xl overflow-hidden border border-border">
              <AccordionItem value="item-1" className="border-b">
                <AccordionTrigger className="p-4 sm:p-5 md:p-6 hover:bg-muted hover:no-underline text-left font-medium text-base sm:text-lg">
                  What is Cydex?
                </AccordionTrigger>
                <AccordionContent className="px-4 sm:px-5 md:px-6 pb-4 sm:pb-6 pt-2 text-sm sm:text-base text-muted-foreground">
          ...
          <div className="mb-12">
            ...
            <Accordion type="single" collapsible className="bg-card shadow-md rounded-xl overflow-hidden border border-border">
              <AccordionItem value="item-1" className="border-b">
                <AccordionTrigger className="p-4 sm:p-5 md:p-6 hover:bg-muted hover:no-underline text-left font-medium text-base sm:text-lg">
      ...
      {/* Contact Support CTA */}
      <section className="py-12 sm:py-16 bg-muted/30 dark:bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 text-center max-w-3xl">
          <div className="bg-card p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-sm sm:shadow-lg border border-border">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Button 
                className="bg-primary hover:bg-primary/90 text-black dark:text-black px-6 py-5 sm:px-8 sm:py-6 text-sm sm:text-base"
