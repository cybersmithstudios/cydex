        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="mb-12">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-bold ml-4">General Questions</h2>
            </div>
            ...
            <Accordion type="single" collapsible className="bg-white shadow-md rounded-xl overflow-hidden border border-gray-100">
              <AccordionItem value="item-1" className="border-b">
                <AccordionTrigger className="p-6 hover:bg-gray-50 hover:no-underline text-left font-medium text-lg">
                  What is Cydex?
                </AccordionTrigger>
          ...
          <div className="mb-12">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-bold ml-4">For Customers</h2>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-bold ml-4">For Riders</h2>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-bold ml-4">For Vendors</h2>
            </div>
